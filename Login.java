...
/*
 * Frame of login gui, allows user to input username and password.
 * 
 * 
 */
...
/*
 * Choosing layout of loginGui, setting size of frame and the kind of layout
 * 
 */
	public Login() {
	...
	private class AddBtnListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			/*
			 * @btn gets the input of text and stores it within a temp variable
			 */
			String Callingbtn = e.getActionCommand();
			if (Callingbtn.equals("Create User")) {
				
				/*
				 * stores the input of user and password.
				 */
			...
			/*
			 * @btn compares temp variables to assure accuracy
			 */

			if (Callingbtn.equals("Login")) {
				String temp1 = usernTxt.getText();
				String temp2 = passTxt.getText();
				user.Search(temp1, temp2);
				usernTxt.setText("");
				passTxt.setText("");
